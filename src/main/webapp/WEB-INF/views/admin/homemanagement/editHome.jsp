				...
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
						<div class="form-group">
							  <label for="categoryCode" class="col-sm-3 control-label no-padding-right">Loại nhà:</label>
							  <div class="col-sm-9">
						...
						<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Diện tích</label>
								<div class="col-sm-9">
									<form:input path="area" cssClass="col-xs-10 col-sm-5"/>
								</div>
						</div>
						<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Giá cho thuê</label>
								<div class="col-sm-9">
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
											<c:if test="${not empty model.id}">
												<button class="btn btn-info" type="button" id="btnAddOrUpdateHome">
...
<script>
	...
	function addHome(data) {
		$.ajax({
            ...
            success: function (result) {
            	window.location.href = "${editHomeURL}?id="+result.id+"&message=insert_success";
            },
	...
	function updateHome(data) {
		$.ajax({
            ...
            dataType: 'json',
            success: function (result) {
            	window.location.href = "${editHomeURL}?id="+result.id+"&message=update_success";
            },
            error: function (error) {
            	window.location.href = "${editHomeURL}?id="+result.id+"&message=error_system";
            }
        });
	}
</script>
